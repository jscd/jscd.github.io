...
for file in "_site/css/theme.css" "_site/css/skylighting-solarized-theme.css" "_site/css/uni.css"; do
  if ! [ -f "$file" ]; then
...
css_rel_path="$("$realpath" "_site/css/" --relative-to "$dest_dir")"
